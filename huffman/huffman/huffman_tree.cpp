...
string huffman_tree::get_desc() {	return desc;	}
string huffman_tree::get_order_symbols() {	return order_symbols;	}
vector<string> huffman_tree::get_codes() {	return codes;	}
Node* huffman_tree::get_tree() {	return tree;	}
